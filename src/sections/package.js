...
const packages = {
  monthly: [
    ...
    },
    {
      ...
      name: "VivModel",
      description: "Milyonlarca model seçeneği ve özelleştirilebilir seçenekler",
      priceWithUnit: "$0",
      buttonText: "Aramıza Katıl",
      ...
      points: [
        {
          id: 1,
          icon: <IoIosCheckmarkCircle />,
          text: "Dünyaca Ünlü Tasarımcıların Modelleri",
          isAvailable: true,
        },
        {
          id: 2,
          icon: <IoIosCheckmarkCircle />,
          text: "1.000.000+ İçerik",
          isAvailable: true,
        },
        {
          id: 3,
          icon: <IoIosCheckmarkCircle />,
          text: "Kendi Modelinizi Oluşturun",
          isAvailable: true,
        },
        {
          id: 4,
          icon: <IoIosCheckmarkCircle />,
          text: "Özgürce Model Havuzu",
          isAvailable: true,
        },
      ],
    },
